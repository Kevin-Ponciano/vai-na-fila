<div class="bg-gray-100 flex flex-col items-center justify-between" x-data="{}">
    <div class="flex flex-col items-center justify-center mt-6 bg-white rounded-lg p-6 shadow-md w-full max-w-md">
        <div class="grid grid-cols-2 gap-4 w-full">
            @forelse($queues as $queue)
                <button class="bg-blue-500 text-white font-semibold py-2 rounded-lg hover:bg-blue-600">
                    {{$queue->name}}
                </button>
            @empty
    ...
    <div data-dial-init class="fixed end-6 bottom-[4rem] group" onclick="closeDial()">
