<footer class="bg-secondary w-full p-4 flex justify-around items-center fixed bottom-0 rounded-t-[2.5rem]">
    <a class="text-xl" href="/filas" wire:navigate wire:current="text-primary">
    ...
    <a class="text-xl" href="/relatorios" wire:navigate wire:current="text-primary">
    ...
    <a class="text-xl" href="/usuarios" wire:navigate wire:current="text-primary">
