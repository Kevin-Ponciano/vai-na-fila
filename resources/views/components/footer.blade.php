<footer class="bg-secondary w-full p-4 flex justify-around items-center fixed bottom-0 rounded-t-[2.5rem]">
    <a class="text-xl" href="{{route('queues')}}" wire:navigate wire:current="text-primary">
    ...
    <a class="text-xl" href="{{route('reports')}}" wire:navigate wire:current="text-primary">
    ...
    <a class="text-xl" href="{{route('users')}}" wire:navigate wire:current="text-primary">
...
<script>
    ...
    // let link = $('footer a[href="/' + currentPath + '"]');
    // if (link.length) {
